...
Il parametro `--min-flanking-chars` è passato da 5 a 3 a 4 in due giorni, ed è la storia più istruttiva del giro. La revisione propose 2 misurando sulle proprie sei ancore; 2 rompe Lan p.84, tabella 1d20, perché i numeri a due cifre contano come righe con parole e la colonna dei numeri diventa una banda. Chat A portò a 3 dichiarando che "3, 4 e 5 danno risultati identici su tutte e sedici": **vero sulle ancore di sviluppo, falso sulle sedici del campione cieco** — M=3 rompe Vil p.223 nello stesso identico modo, e con esso circa dodici pagine del bestiario Vil che ripetono la stessa tabella di dadi (misurato dal sesto giro: 56 gutter recuperati fra M=5 e M=3 su quattro manuali, il 75% con il lato povero largo meno di un quarto dell'altro). Portato a 4, primo valore che rifiuta entrambi. **Non è un valore verificato**: è il pavimento sui casi guardati finora, e i gutter che 4 e 5 separano non sono stati ispezionati. Due volte di fila una soglia è stata scelta su un campione troppo piccolo e corretta dal campione successivo.

Regola "vince la banda esterna", e la sua giustificazione da rifare. Il commit che l'ha introdotta sostiene che in una tabella l'ordine corretto sia per righe e che quindi serva comunque il livello esterno: **è falso**. Scegliere la banda esterna non dà lettura per righe, dà lettura **per colonne al gutter più esterno** — verificato sul markdown di DB p.76, tabella di armi a nove colonne, dove la baseline con la sola correzione di riga legge correttamente per righe e il ramo a bande la spezza in colonne. Il "294 primitive su 294 dentro una banda" citato come successo **misura il danno**, non il risultato: quella metrica si satura per costruzione appena esiste una banda di primo livello larga quanto la pagina. E il costo dichiarato "caso raro, nessun esempio osservato" è sbagliato: **il 36,7% delle pagine con bande ha annidamento** (243 su 663, quattro manuali), e su tutte quelle la regola scarta ogni livello sotto lo zero, rendendo la ricorsione dell'albero inerte nel consumer. La formulazione onesta è: entrambe le regole sono sbagliate sulle tabelle, l'esterna è meno frammentaria, e **la distinzione tabella/prosa non è eludibile**.

Quest'ultimo punto riapre con un esempio vero la questione ritirata sopra: su Vil p.223 una colonna di numeri di tabella diventa una banda e nessun livello a valle la recupera. È il caso misurato che il ritiro chiedeva. Non riaperta: registrata.
