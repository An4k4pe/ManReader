...
Provenienza delle misure di questi tre paragrafi: raccolte in sessione l'11 agosto 2026 con gli script di 786b547, prima mano, output in `output/diagnostics_column_band/` (non nel repo, rigenerabile). Il fallimento Dag e le sue due cause sono misurati; il principio sulle soglie è una posizione, non una misura.
